    ...
    <section className="flex min-h-screen items-center justify-center px-6 pt-20">
      <div className="mx-auto flex max-w-3xl flex-col items-center gap-8 text-center">
        <div className="inline-flex items-center gap-2 rounded-full border border-border bg-card px-4 py-1.5">
          ...
          <span className="text-xs text-muted-foreground">AI-powered content workspace</span>
        </div>
        <h1 className="text-balance font-serif text-4xl font-bold leading-tight tracking-tight text-foreground md:text-5xl lg:text-6xl">
          Create marketplace content in one window
        </h1>
        <p className="max-w-xl text-pretty text-base leading-relaxed text-muted-foreground md:text-lg">
          Pixorion.ai combines image generation, product card analysis and content optimization tools in a single workspace.
        </p>
